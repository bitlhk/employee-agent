...
describe("role asset grants", () => {
    ...
    expect(grants).toEqual([
      {
        ...
        assetId: "wealth_assistant_customer",
        grantMode: "default",
        source: "seed",
        enabled: true,
      },
  ...
  it("plans seed upsert/prune without touching admin or market grants", () => {
    ...
    expect(plan.upsert.map((grant) => grant.assetId).sort()).toEqual(["new-default", "wealth_assistant_customer"]);
  });
