...
INSTALLER_VERSION="2026.08.20.1"
...
DEFAULT_REPO_REF="44b35872d43fe4247c2f4806b3a78e0a04a3738a"
...
JIUWENSWARM_REF="${JIUWENSWARM_REF:-03eaaf5bcac08135589f86eae6c6c15f9ec9960f}"
JIUWENSWARM_VERSION="${JIUWENSWARM_VERSION:-0.2.3+ea.13}"
