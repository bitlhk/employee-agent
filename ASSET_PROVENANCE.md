...
The following assets are maintained as part of Workforce Agent Platform and
do not contain third-party channel or runtime logos:

- `client/public/images/workforce-agent.svg`
- `client/public/favicon.svg`
- `client/public/favicon.png`
- `client/public/favicon_transparent.png`
...
is used solely as the avatar for the Wind Alice expert:

- Distributed asset: `client/public/images/experts/alice.png`
- Source: project-owner supplied source file
- Retrieved: 2026-07-22
